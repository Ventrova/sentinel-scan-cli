...
Dry-run verified 2026-08-23: `python -m build` succeeds, `twine check dist/*` PASSED for both
the wheel and sdist, version is 1.1.0, README renders as Markdown (Description-Content-Type:
text/markdown), and classifiers/metadata are valid.
