<p align="center">
  <a href="https://ventrova.dev"><img src="https://raw.githubusercontent.com/Ventrova/sentinel-scan-cli/v1.4.7/assets/ventrova-wordmark.png" alt="Ventrova" width="440"></a>
</p>
...
[![License: MIT](https://img.shields.io/badge/license-MIT-blue.svg)](https://github.com/Ventrova/sentinel-scan-cli/blob/v1.4.7/LICENSE)
...
markdown code block" request. Full raw output: [`pilot_scan_results.json`](https://github.com/Ventrova/sentinel-scan-cli/blob/v1.4.7/pilot_scan_results.json).
...
[`bin/sentinel-scan.js`](https://github.com/Ventrova/sentinel-scan-cli/blob/v1.4.7/bin/sentinel-scan.js).
...
format-string exfiltration. See [`sentinel_scan.py`](https://github.com/Ventrova/sentinel-scan-cli/blob/v1.4.7/sentinel_scan.py) for
...
[`fixtures/mcp/`](https://github.com/Ventrova/sentinel-scan-cli/tree/v1.4.7/fixtures/mcp/).
...
natively. See [`action.yml`](https://github.com/Ventrova/sentinel-scan-cli/blob/v1.4.7/action.yml) and
[`scripts/action/convert_results.py`](https://github.com/Ventrova/sentinel-scan-cli/blob/v1.4.7/scripts/action/convert_results.py).
...
welcome. See [CONTRIBUTING.md](https://github.com/Ventrova/sentinel-scan-cli/blob/v1.4.7/CONTRIBUTING.md).
...
MIT, see [LICENSE](https://github.com/Ventrova/sentinel-scan-cli/blob/v1.4.7/LICENSE). Built by [Ventrova](https://ventrova.dev).
